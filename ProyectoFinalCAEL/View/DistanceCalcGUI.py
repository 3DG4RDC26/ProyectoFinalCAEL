...
class DistanceCalcGUI(QDialog):
    ...
    def init_ui(self):
        ...
        self.graph_widget.setMinimumSize(320, 200)
        self.graph_widget.setMaximumSize(400, 250)
        self.graph_widget.setStyleSheet('background: #d3d3d3;')
        self.figure, self.ax = plt.subplots()
        self.canvas = FigureCanvas(self.figure)
        graph_layout = QVBoxLayout(self.graph_widget)
        graph_layout.setAlignment(Qt.AlignmentFlag.AlignHCenter)
        graph_layout.addWidget(self.canvas)
        centro.addSpacing(10)
        centro.addWidget(self.graph_widget, alignment=Qt.AlignmentFlag.AlignHCenter)
        # Botón Calcular
